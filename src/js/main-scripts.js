(function ($) {
    ...
    /*====== PagePiling ======*/
    SYABAB.PageScrollEffect = function () {
    ...
    /*====== Owl Carousel ======*/
    SYABAB.Slider1 = function () {
        var rtl = $("body").attr("data-SYABAB-rtl");
    ...
    SYABAB.ParticlesThree = function () {
    ...
    $(document).ready(function () {
        SYABAB.PageScrollEffect(), SYABAB.Slider1(), SYABAB.Slider2(), SYABAB.Slider3(), SYABAB.SliderHero(), SYABAB.ParticlesOne(), SYABAB.ParticlesTwo(), SYABAB.ParticlesThree(), SYABAB.ParticlesFour(), SYABAB.Sidenav(), SYABAB.Gallery(), SYABAB.DataFilters(), SYABAB.Typed(), SYABAB.Typed1(), SYABAB.ContactForm();
    });
})(jQuery);
